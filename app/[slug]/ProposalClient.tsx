...
// Recharts loaded client-side only — prevents SSR crash
...
export default function ProposalClient({ slug }: { slug: string }) {
  ...
  // ── Available terms (from flags + data presence)
  ...
  // ── TOU breakdown for selected term
  ...
  // Tariff bars — only for available terms
