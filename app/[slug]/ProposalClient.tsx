      ...
      <div className="max-w-4xl mx-auto px-5">
        ...
        <section className="py-14">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
            ...
            <Stat label={`Total ${term}-yr Savings`} value={fmtMill(totalContractSavings)} sub="cumulative contract" />
          </div>

          {/* Row 2 — financial KPIs */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
            <Stat label="Value Return"   value={`${fmt(valueReturn,1)}%`}       sub="savings on Apollo cost" accent />
