    ...
    <div className="min-h-screen bg-charcoal text-offwhite font-sans">
      ...
      <div className="max-w-4xl mx-auto px-5">
        ...
        <section className="py-14">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
            <Stat label="Value Return"   value={`${fmt(valueReturn,1)}%`}      sub="Deal IOs D48"    accent />
            <Stat label="NPV Savings"    value={fmtMill(npvSavings)}           sub="net present value" />
            <Stat label="Credit Support" value={`R${fmt(baseCredit,1)}m`}      sub="ZAR million"     accent />
            <Stat label="GHG Savings"    value={`${fmt(ghgAnnual,0)} tCO₂e`}  sub="per year · Deal IOs D64" />
          </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="px-5 py-3 bg-gray-50 border-t border-gray-100">
                  <p className="text-gray-400 text-[11px]">
                    Apollo tariffs from 1 April 2026 · Eskom WEPS MR · High season = Jun–Aug · Low season = Sep–May · Apollo escalates at CPI annually.
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {['ESG / TCFD','CDP / JSE','GHG Protocol','EU CBAM'].map(b => (
                      <span key={b} className="bg-green/8 border border-green/20 text-green text-[10px] font-semibold px-2 py-1 rounded-lg">{b}</span>
                    ))}
                  </div>
                </div>
              </div>
