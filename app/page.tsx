      ...
      <div className="max-w-4xl mx-auto px-5">
        ...
        <section className="py-14">
          ...
          <div className="bg-forest border border-border rounded-2xl p-5 mb-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full border"
                  ...
                  {multiplier<0.95?'Conservative':multiplier<1.05?'Contracted':multiplier<1.30?'Uplifted':multiplier<1.60?'Carbon-Neutral':'Maximum Green'}
                </span>
            ...
            />
            <div className="flex justify-between text-[10px] font-semibold uppercase tracking-wide mb-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              {([
                {id:'A',label:'Zone A',title:'Max Savings',   range:'80–99%',  desc:'Maximum cash flow. Ideal for CFO cost mandates.',         color:'#10B981'},
