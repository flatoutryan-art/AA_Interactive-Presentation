...
async function parseOfferbook(file: File): Promise<ParsedOfferbook> {
  ...
  // Monthly supply/load: Energy volumes sheet, row 41 (supply) & row 11 (load), cols E–P
  const COLS = ['E','F','G','H','I','J','K','L','M','N','O','P'];
  ...
  return {
    ...
    contract_mwh: contractMwh, customer_load_mwh: customerLoad,
